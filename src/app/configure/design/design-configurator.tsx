    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
        <ScrollArea className="relative flex-1 overflow-auto">
          <div
            aria-hidden="true"
            className="absolute z-10 inset-x-0 bottom-0 h-12 bg-gradien-to-t from-white to-red-500 pointer-events-none"
          />
            ...
            <div className="relative mt-4 h-full flex flex-col justify-between">
              <div className="flex flex-col gap-6">
                ...
                >
                  ...
                  <div className="mt-3 flex items-center skew-x-3">
                    {COLORS.map((color) => (
                      <Radio
                        key={color.label}
                        value={color}
                  ...
                  ({ name, options: selectableOptions }) => (
                    ...
                    >
                      ...
                      {selectableOptions.map((option) => (
                        <Field key={option.value} className="mt-3 space-y-4">
                          <Radio
                            value={option}
                            className={({ checked }) =>
                              cn(
        ...
        <div className="w-full px-8 h-16 bg-white">
          ...
          <div className="w-full h-full flex justify-end items-center">
            <div className="w-full flex gap-6 items-center">
              ...
              >
                Continue
                <ArrowRight className="h-full w-4 ml-1.5 inline" />
              </Button>
            </div>
          </div>
        </div>
